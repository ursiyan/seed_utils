...
def generate_addresses():
    ...
    # Display the Ethereum addresses
...
seed_label2 = tk.Label(frame2, text="Введите Seed фразу:")
seed_label2.pack(pady=10)
seed_entry2 = tk.Entry(frame2, width=50)
seed_entry2.pack(pady=10)
...
result_text2 = tk.Text(frame2, width=50, height=10)
